...
import com.example.finalprojectsunday.helpers.BitmapHelper;

import static com.example.finalprojectsunday.helpers.ResourcesHelper.getStringResourceByKey;
...
public class Notify {
    ...
    public static com.example.finalprojectsunday.Notify build(@NonNull Context context){ return new com.example.finalprojectsunday.Notify(context); }
    ...
    public com.example.finalprojectsunday.Notify setTitle(@NonNull String title) {
        if (!title.isEmpty())
            this.title = title;
        return this;
    }

    public com.example.finalprojectsunday.Notify setContent(@NonNull String content) {
        if (!content.isEmpty())
            this.content = content;
        return this;
    }

    public com.example.finalprojectsunday.Notify setChannelId(@NonNull String channelId) {
    ...
    public com.example.finalprojectsunday.Notify setChannelName(@NonNull String channelName) {
        if (!channelName.isEmpty())
            this.channelName = channelName;
        return this;
    }

    public com.example.finalprojectsunday.Notify setChannelDescription(@NonNull String channelDescription) {
        if (!channelDescription.isEmpty())
            this.channelDescription = channelDescription;
        return this;
    }

    public com.example.finalprojectsunday.Notify setImportance(@NonNull NotifyImportance importance){
    ...
    public com.example.finalprojectsunday.Notify enableVibration(boolean vibration) {
        this.vibration = vibration;
        return this;
    }

    public com.example.finalprojectsunday.Notify setAutoCancel(boolean autoCancel) {
        this.autoCancel = autoCancel;
        return this;
    }

    public com.example.finalprojectsunday.Notify largeCircularIcon() {
        this.circle = true;
        return this;
    }

    public com.example.finalprojectsunday.Notify setVibrationPattern(long[] vibrationPattern) {
        this.vibrationPattern = vibrationPattern;
        return this;
    }

    public com.example.finalprojectsunday.Notify setColor(@ColorRes int color) {
        this.color = color;
        return this;
    }

    public com.example.finalprojectsunday.Notify setSmallIcon(@DrawableRes int smallIcon) {
        this.smallIcon = smallIcon;
        return this;
    }

    public com.example.finalprojectsunday.Notify setLargeIcon(@DrawableRes int largeIcon) {
        this.largeIcon = largeIcon;
        return this;
    }

    public com.example.finalprojectsunday.Notify setLargeIcon(@NonNull String largeIconUrl) {
        this.largeIcon = largeIconUrl;
        return this;
    }

    public com.example.finalprojectsunday.Notify setPicture(@DrawableRes int bigPicture) {
        this.picture = bigPicture;
        return this;
    }

    public com.example.finalprojectsunday.Notify setPicture(@NonNull String bigPictureUrl) {
        this.picture = bigPictureUrl;
        return this;
    }

    public com.example.finalprojectsunday.Notify setAction(@NonNull Intent action) {
        this.action = action;
        return this;
    }

    public com.example.finalprojectsunday.Notify setId(int id) {
        this.id = id;
        return this;
    }
